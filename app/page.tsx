  ...
  const widgets = [
    {
      ...
      sub: data.email?.latest || (data.email ? "No new emails" : "Connect Google"),
      color: "text-red-400",
      href: "/email",
    ...
    },
    {
      ...
      sub: data.calendar?.next || (data.calendar ? "No events today" : "Connect Calendar"),
      color: "text-blue-400",
      href: "/calendar",
    ...
    },
    {
      ...
      sub: data.github?.notifications !== undefined
        ? (data.github.prs ? `${data.github.prs} open PRs` : `${data.github.notifications} notifications`)
        : "Connect GitHub",
      color: "text-gray-400",
      href: "/github",
    ...
    },
    {
      ...
      sub: data.tasks?.today ? `${data.tasks.today} due today` : (data.tasks ? "No tasks pending" : "Connect Tasks"),
